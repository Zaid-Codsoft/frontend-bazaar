                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <div className="flex items-baseline gap-2 text-3xl font-medium">
                                        <span className="text-gray-800">PKR {product.price?.toLocaleString()}</span>
                                        <span className="text-base text-gray-500 line-through">PKR {product.cuttedPrice?.toLocaleString()}</span>
                                    ...
                                    {Array(1).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first Bazaar When you buy our subscription (Good to see you) <Link className="text-primary-blue font-medium" to="/"></Link>
                                        </p>
                                    ))}
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between">
                                        ...
                                        <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                            ...
                                            <ul className="flex flex-col gap-2">
                                                ...
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-blue"></span> Cash on Delivery available</p>
                                                </li>
                                            </ul>
                                        </div>
