...
const Products = () => {
    ...
    return (
        <>
            <MetaData title="All Products | Bazaar" />
                            ...
                            <div className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 border-b px-4">
                                    ...
                                    <div className="flex gap-3 items-center justify-between mb-2 min-w-full">
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">PKR {price[0].toLocaleString()}</span>
                                        <span className="font-medium text-gray-400">to</span>
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">PKR {price[1].toLocaleString()}</span>
                                    </div>
                                </div>
                                {/* price slider filter */}
                    ...
                    <div className="flex-1">
                        ...
                        {!loading && products?.length === 0 && (
                            <div className="flex flex-col items-center justify-center gap-3 bg-white shadow-sm rounded-sm p-6 sm:p-16">
                                <img draggable="false" className="w-1/2 h-44 object-contain" src="logo.png" alt="Search Not Found" />
